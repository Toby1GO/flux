...
已安装旧版面板的服务器可执行同一命令，在菜单中选择“2. 更新面板”。更新过程会保留数据库卷和现有配置，并自动增加转发到期时间字段。
节点端(稳定版)：
```bash
...
[![Star History Chart](https://api.star-history.com/svg?repos=Toby1GO/flux&type=Date)](https://www.star-history.com/#Toby1GO/flux&Date)
